...
public abstract class VacuumWorldGoalStack extends GoalStack<VacuumWorldGoal, VacuumWorldAction> {
	...
	for (int i = 0; i < goals.size(); i++) {
	    b.append(goals.get(i).getClass().getSimpleName() + System.lineSeparator());
	}
