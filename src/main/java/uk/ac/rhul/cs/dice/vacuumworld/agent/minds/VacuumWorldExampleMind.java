...
public class VacuumWorldExampleMind extends VacuumWorldMind {
	...
	/*
	 * When developing your agent mind, you should extend VacuumWorldMind, just
	 * like this class does and implement the perceive, decide and execute
	 * methods. To stick to software engineering practices you should use the
	 * Logger that is provided statically by VacuumWorldMind -
	 * VacuumWorldMind.LOGGER (or LOGGER if you are within a subclass of
	 * VacuumWorldMind as here)
	 */
