...
public class DefaultButton extends CustomButton {
	...
	this.setPressed(ImageUtilities.getOverlayedImage(image, Color.BLACK, 0.4f));
    }

    private static BufferedImage loadButtonImage(String imgname) {
	return VacuumWorldView.IMGLOADER.loadImage(VacuumWorldView.IMGPATH + imgname + VacuumWorldView.EXTENSION);
    }
}