...
public class VacuumWorldAgentAppearanceReadOnly extends VacuumWorldAgentAppearance {
    ...
    public VacuumWorldAgentAppearanceReadOnly(VacuumWorldAgentAppearance appearance) {
	super(appearance.getId(), appearance.getBody(), appearance.getSensors(), appearance.getActuators());
	...
	return APPEARANCETOSTRING + getColor() + "," + getPosition() + "," + getOrientation() + "}";
    }
}
