...
public class VacuumWorldControlButtonPanel extends JPanel {
    ...
    static final Dimension SMALLBUTTONDIMENSION = new Dimension(SMALLBUTTONSIZE, SMALLBUTTONSIZE);

    public VacuumWorldControlButtonPanel(BufferedImage play, OnClick playclick, BufferedImage restart,
	    OnClick restartclick, BufferedImage pause, OnClick pauseclick, BufferedImage settings,
	    OnClick settingsclick, BufferedImage off, OnClick offclick) {
	this.setLayout(new GridLayout(1, 4));
	this.setPreferredSize(new Dimension(SMALLBUTTONSIZE * 3, SMALLBUTTONSIZE));
	...
	public ControlButton(BufferedImage image, OnClick onclick) {
	    super(ImageUtilities.getOverlayedImage(image, Color.WHITE, 0.4f), onclick);
	    this.setPressed(ImageUtilities.getOverlayedImage(image, Color.WHITE, 0.8f));
	    this.setHover(ImageUtilities.getOverlayedImage(image, Color.WHITE, 0.6f));
