...
public class VacuumWorldView extends JFrame implements Observer {
    ...
    /*
     * These should not be transient, however this class will not be serialised, it
     * will not be an issue until (if ever) the view needs to be serialised.
     */
	...
	private void loadMainPanel() {
	    ...
	    VacuumWorldView.this.getContentPane().setPreferredSize(MAINDIMENSION);
	    VacuumWorldView.this.getContentPane().add(mainpanel, BorderLayout.CENTER);
