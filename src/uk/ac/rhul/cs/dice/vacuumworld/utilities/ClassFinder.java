...
public class ClassFinder {
    ...
    public static Collection<Class<?>> findAllClasses() throws IOException, ClassNotFoundException {
	...
	for (URL u : urls) {
		...
		for (String name : names) {
		    //THIS STEP IS TO ENSURE THAT FROM ECLIPSE YOU WON'T GET A CLASSNOTFOUNDEXCEPTION!!!
    ...
    public static Collection<String> getClassNamesFromJar(File jar) throws IOException {
